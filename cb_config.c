...
void AbrirVirtualKeyboard(GtkWidget *widget)
{
  ...
  // Salva a tela atual para retornar na saída
  WorkAreaOrigemVK = WorkAreaGet();
  ...
  if(lbl && GTK_IS_LABEL(lbl)) {
    gtk_label_set_text(lblVK, gtk_label_get_text(lbl));
